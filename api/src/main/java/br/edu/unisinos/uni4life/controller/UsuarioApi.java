...
public interface UsuarioApi {
    ...
    @ApiOperation(value = "Operação responsável por consutar os usuários que esta seguindo.",
    ...
    @ApiOperation(value = "Operação responsável por consutar os usuários para seguir.",
